    ...
    <div class="container" style="opacity: 0.93;">
        ...
        <div class="row">
            <div class="col-lg-12 text-left">
                ...
                <p class="h4">ABLE TO LEAP tall buildings in single bound, THE RT-Blower, the newest addition to RT transport balls from even the most remote locations. With almost limitless flexibility the RT-Blower can quickly and reliably fill one or several Ball Dispenser or Automatic Tee-Up System. As with all Range Tech Ball Management Systems this can be done at the push of a button or automatically. Designed to minimize labor and isolate the ball washing area the RT-Blower makes for an efficient, clean, and safe range.</p><br><br><br><br><br><br>
               <table align="center"><tr><td><img src="../media/blower1.jpg" alt="Blower / Shooter System" align="center" style="width:140%;height:130%;"></td></tr></table><br><br><br><br>
                ...
                <table align="center"><tr><td colspan="2"><img src="../media/blowershooter.jpg" alt="Blower / Shooter System" align="center" style="width:100%; height:30%;"><tr><td><br><br></td></tr></td></tr><tr><td width="20%"></td><td><img src="../media/blower4.jpg" alt="Blower / Shooter System" align="center" style="width:80%;height:80%;"></td></tr></table>
            </div>
        </div>
        <!-- /.row -->
