    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-left">
                <div class="carousel slide" data-ride="carousel" align="center">
                              <div class="carousel-inner">
                                <div class="item active">
                                    <a href="#"><img src="http://placehold.it/254x150/ff3546/f5f5f5/&text=New+Collection" class="img-responsive" alt="product 1"></a>
                                    <h4><small>Summer dress floral prints</small></h4>                                        
                ...
                <br><br>
                <table align="center"><tr><td colspan="2" width="65%"><img src="../media/lbms.jpg" align="left" alt="Large Ball Manangement System" style="width:150%;height:110%;"></td><td colspan="2"></td></tr></table>
...
<br><br>
                 <br><br><table align="center"><tr><td colspan="2" width="60%"><img src="../media/lbms.jpg" align="left" alt="Large Ball Manangement System" style="width:150%;height:110%;"></td><td colspan="2"></td></tr><tr><td colspan="2" width="60%"><img src="../media/lbms.jpg" align="left" alt="Large Ball Manangement System" style="width:150%;height:110%;"></td><td colspan="2"></td></tr></table>
            </div>
        </div>
        <!-- /.row -->
